...
func (x *CheckInventory) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckInventory) ProtoMessage() {}

func (x *CheckInventory) ProtoReflect() protoreflect.Message {
	mi := &file_proto_inventory_proto_msgTypes[0]
...
// Deprecated: Use CheckInventory.ProtoReflect.Descriptor instead.
func (*CheckInventory) Descriptor() ([]byte, []int) {
	return file_proto_inventory_proto_rawDescGZIP(), []int{0}
}

func (x *CheckInventory) GetItems() []*Item {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *CheckInventoryResponse) GetOk() bool {
	if x != nil {
		return x.Ok
	}
	return false
...
var file_proto_inventory_proto_rawDesc = []byte{
	...
	0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2d, 0x0a, 0x0e, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x1b, 0x0a, 0x05, 0x69, 0x74, 0x65,
	0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x52,
	0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x28, 0x0a, 0x16, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x49,
	...
	0x69, 0x74, 0x79, 0x32, 0x4a, 0x0a, 0x15, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x49, 0x6e, 0x76, 0x65,
	0x6e, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x31, 0x0a, 0x05,
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x0f, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x49, 0x6e, 0x76,
	0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x1a, 0x17, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x49, 0x6e,
	0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42,
	0x11, 0x5a, 0x0f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f,
...
var file_proto_inventory_proto_goTypes = []interface{}{
	(*CheckInventory)(nil),         // 0: CheckInventory
	(*CheckInventoryResponse)(nil), // 1: CheckInventoryResponse
	(*Item)(nil),                   // 2: Item
}
var file_proto_inventory_proto_depIdxs = []int32{
	2, // 0: CheckInventory.items:type_name -> Item
	0, // 1: CheckInventoryService.Check:input_type -> CheckInventory
	1, // 2: CheckInventoryService.Check:output_type -> CheckInventoryResponse
